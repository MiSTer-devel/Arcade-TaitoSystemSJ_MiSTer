## Generated SDC file "Arcade-TaitoSJ.out.sdc"
...
create_clock -name {emu:emu|taitosj_fpga:tssj|clkm_6MHZ} -period 166.600 -waveform { 0.000 83.300 } [get_registers {emu:emu|taitosj_fpga:tssj|clkm_6MHZ}]
...
set_clock_uncertainty -rise_from [get_clocks {emu:emu|taitosj_fpga:tssj|clkm_6MHZ}] -rise_to [get_clocks {emu:emu|taitosj_fpga:tssj|clkm_6MHZ}]  0.270  
set_clock_uncertainty -rise_from [get_clocks {emu:emu|taitosj_fpga:tssj|clkm_6MHZ}] -fall_to [get_clocks {emu:emu|taitosj_fpga:tssj|clkm_6MHZ}]  0.270  
set_clock_uncertainty -rise_from [get_clocks {emu:emu|taitosj_fpga:tssj|clkm_6MHZ}] -rise_to [get_clocks {emu|pll|pll_inst|altera_pll_i|general[1].gpll~PLL_OUTPUT_COUNTER|divclk}]  0.250  
set_clock_uncertainty -rise_from [get_clocks {emu:emu|taitosj_fpga:tssj|clkm_6MHZ}] -fall_to [get_clocks {emu|pll|pll_inst|altera_pll_i|general[1].gpll~PLL_OUTPUT_COUNTER|divclk}]  0.250  
set_clock_uncertainty -rise_from [get_clocks {emu:emu|taitosj_fpga:tssj|clkm_6MHZ}] -rise_to [get_clocks {emu|pll|pll_inst|altera_pll_i|general[0].gpll~PLL_OUTPUT_COUNTER|divclk}]  0.310  
set_clock_uncertainty -rise_from [get_clocks {emu:emu|taitosj_fpga:tssj|clkm_6MHZ}] -fall_to [get_clocks {emu|pll|pll_inst|altera_pll_i|general[0].gpll~PLL_OUTPUT_COUNTER|divclk}]  0.310  
set_clock_uncertainty -fall_from [get_clocks {emu:emu|taitosj_fpga:tssj|clkm_6MHZ}] -rise_to [get_clocks {emu:emu|taitosj_fpga:tssj|clkm_6MHZ}]  0.270  
set_clock_uncertainty -fall_from [get_clocks {emu:emu|taitosj_fpga:tssj|clkm_6MHZ}] -fall_to [get_clocks {emu:emu|taitosj_fpga:tssj|clkm_6MHZ}]  0.270  
set_clock_uncertainty -fall_from [get_clocks {emu:emu|taitosj_fpga:tssj|clkm_6MHZ}] -rise_to [get_clocks {emu|pll|pll_inst|altera_pll_i|general[1].gpll~PLL_OUTPUT_COUNTER|divclk}]  0.250  
set_clock_uncertainty -fall_from [get_clocks {emu:emu|taitosj_fpga:tssj|clkm_6MHZ}] -fall_to [get_clocks {emu|pll|pll_inst|altera_pll_i|general[1].gpll~PLL_OUTPUT_COUNTER|divclk}]  0.250  
set_clock_uncertainty -fall_from [get_clocks {emu:emu|taitosj_fpga:tssj|clkm_6MHZ}] -rise_to [get_clocks {emu|pll|pll_inst|altera_pll_i|general[0].gpll~PLL_OUTPUT_COUNTER|divclk}]  0.310  
set_clock_uncertainty -fall_from [get_clocks {emu:emu|taitosj_fpga:tssj|clkm_6MHZ}] -fall_to [get_clocks {emu|pll|pll_inst|altera_pll_i|general[0].gpll~PLL_OUTPUT_COUNTER|divclk}]  0.310  
